...
DELIMITER $$
USE `stockblogger`$$
CREATE PROCEDURE `add_comment`(IN POST_ID_INPUT INT,IN USER_ID_INPUT INT,IN COMMENT_BODY_INPUT VARCHAR(1000),IN COMMENT_DATE_INPUT DATE)
BEGIN
...
DELIMITER $$
USE `stockblogger`$$
CREATE PROCEDURE `edit_post` (IN POST_ID_INPUT INT,IN USER_ID_INPUT INT,IN TITLE_INPUT VARCHAR(75),IN POST_BODY_INPUT VARCHAR(5000),IN POST_DATE_INPUT DATE)
BEGIN
...
DELIMITER $$
USE `stockblogger`$$
CREATE PROCEDURE `edit_comment`(IN COMMENT_ID_INPUT INT,IN POST_ID_INPUT INT,IN USER_ID_INPUT INT,IN COMMENT_BODY_INPUT VARCHAR(1000),IN COMMENT_DATE_INPUT DATE)
BEGIN
